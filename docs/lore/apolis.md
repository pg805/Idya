# The Apolis Continent

Designer-facing. This is the whole picture, including the parts players are not
meant to know. The player-facing version is `world_player.md`, served at
`/api/info/lore`.

Written to the house style in `voice.md`: no em dashes, no en dashes in prose.
...
The Chaevul lived on Apolis before, as part of an empire that spanned both
continents. They worshipped Apolis then.
...
The Chae emperor is funding an expedition to establish a mine, and he is doing it
...
Scientists and arcanists. They want talamite for its properties. A mine full of
it means tools that conduct sidaev, in quantity, for their experiments and their
work.
...
The subtlest goals of the five. As a church, they claim not to care for material
...
Fendalok grew up on stories about the Apolis continent, and one of them was about
the **Sword of Apolis**: a blade hidden underground, findable only by the worthy.

He wants it. He has a hunch the stories were pointing at roughly this location,
and that hunch is the actual reason he volunteered for the posting.
